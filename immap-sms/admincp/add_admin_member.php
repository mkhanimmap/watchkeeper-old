...
if(isset($_POST["cell"]))
 {
			 ...
			 $ins_id = $admin->Insert("sms_admin_user", $arrValue);
			if($ins_id)
				 header("Location:admin_members.php?msg=".base64_encode(1)); 
			else
			   $msg =   $admin->display_msg('Error while adding admin member!',false);
    ...
    <form name="form_member" id="form_member" action="" method="post" >
	 <input type="hidden" name="path" id="path" value="<?php echo FULL_PATH?>" /> 
      ...
      <table width="100%" height="28" cellpadding="1" cellspacing="1">
        ...
        <tr>
          <td height="17">&nbsp;</td>
          <td class="tb_h3" ><input type="submit" name="editmembers" id="addmember" value="Add Admin Member"  />
