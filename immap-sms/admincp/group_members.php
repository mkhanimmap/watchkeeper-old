...
if( isset($_POST['delete'])  )
 {
	...
	$del = isset($_POST["Unsubscribe"])?$_POST["Unsubscribe"]:"";
 	foreach($del as $val)
	 {
		  $qry = "delete from sms_user_group where group_id =".base64_decode($gid)." and user_id =".$val;
		 pg_query($qry);
	 }
	
	 header("location:group_members.php?gid=".$gid."&msg=".base64_encode(3));
 ...
 $pages->baseQry  = "Select u.*,ug.group_id from ".TBLUSER." u inner join sms_user_group ug on u.id = ug.user_id where ug.group_id = ".base64_decode($gid)." order by u.id desc";// WHERE status = '1'
...
<div class="hea_right3">
    <div class="auto1_div"></div>
	   ...
	   <div class="auto1_div2">
	   		<a href="add_members.php?gid=<?php echo $gid?>" class="hea_txt">Assign Member</a>
	   </div>
		<div class="auto1_div">
  ...
  <div class="mid"> 
    ...
    <div>
      <form name="form_plan" id="form_plan" action="" method="post" >
        ...
        <br/>
          <span class="h1_box_2"> 
        <div class="all_box"><?php echo getField('group_name',TBLGROUP,base64_decode($gid));?>'s Members</div></span>
          <br />
      ...
      <table width="100%" height="28" cellpadding="2" cellspacing="2">
        <tr>
          ...
          <td class="tb_h2">&nbsp;</td>
          <td class="tb_h2">&nbsp;</td>
          <td class="tb_h2" align="right"><input type="button" name="button" id="button" value="Back" onclick="javascript:window.location.href='groups.php'" /></td>
	  ...
	  if(!empty($rows))
        ...
        <tr bgcolor="#FBD4D5">
          ...
          <td width="83" class="tb_h2">Unsubscribe</td>
          <td width="337" height="20" class="tb_h2"><a href="add_group.php" class="hea_txt">Members</a></td>
          <td width="126" class="tb_h2">Organization</td>
          <td width="113" class="tb_h2">Group</td>
          <td width="109" class="tb_h2">Cell</td>
		...
		<tr>
          <td align="left" colspan="6" class="tb_h2">
              <input type="submit" name="delete" id="delete" value="Unsubscribe Members from <?php echo getField('group_name',TBLGROUP,base64_decode($gid));?>" />    
               </td>
        </tr>
        <tr>
