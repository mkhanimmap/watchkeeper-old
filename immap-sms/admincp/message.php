...
if(isset($_POST["add_ms"]))
 {
	...
	$chkbox = isset($_POST["chk"])?$_POST["chk"]:"";
	$count = count($chkbox);
	...
	for($i=0; $i<$count; $i++)
	{
		if(!empty($_POST["chk"][$i]))
		 { 
		  ...
		  $msisdn_to = getField('cell','sms_user',$_POST["chk"][$i]);
...
/*while(true)
	{*/
	 ...
	 $rsQry = "select * from sms_outbound WHERE status = 0 order by id desc LIMIT 50 offset 0";
    ...
    <input type="hidden" name="organization_h" id="organization_h" value="" />
     <input type="hidden" name="group_h" id="group_h" value="" />
      ...
      <table width="100%" height="28" cellpadding="1" cellspacing="1">
         ...
         <tr id="tr_msg">
          <td width="109" class="tb_h3" valign="top">Group:</td>
          <td width="404" id="output" >
         	<span class="tb_h3" id="group_span">
               <?php
                 echo getGroupChDD();
               ?>
              </span>
         ...
         <tr id="tr_msg">
          <td width="109" class="tb_h3" valign="top">SubGroup Name:</td>
          <td width="404" id="output" >
		  	<span class="tb_h3" id="subgroup_span">
               
			   <select class="sign_inp">
        ...
        <tr>
          <td width="109" class="tb_h3" valign="top"></td>
          <td colspan="2" id="memb" >
                        &nbsp;&nbsp;         </td>
          </tr>
