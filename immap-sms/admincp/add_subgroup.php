...
if(isset($_POST["editmembers"]))
 {
				...
				$msg = "";
					...
					$arrValue = array (	
					 ...
					 $ins_id = $admin->Insert(TBLSUBGROUP, $arrValue);
					 if($ins_id)
					  {				
							    header("Location:subgroups.php?msg=".base64_encode(1)); 
					 }
					 else
					  {
					   $msg =   $admin->display_msg('SubGroup has been not added succresfully!',false);
					  }
    ...
    <form name="form_member" id="form_member" action="" method="post" >
	 <input type="hidden" name="path" id="path" value="<?php echo FULL_PATH?>" />
      <table width="100%" height="28" cellpadding="1" cellspacing="1">
         <tr>
           <td class="tb_h3" >SubGroup Name:</td>
           <td ><span class="tb_h3">
             <input name="subgroup" type="text" class="sign_inp" id="subgroup" style="width:400px;" />
           </span></td>
         </tr> 
         <tr>
           <td class="tb_h3" >SubGroup short code:</td>
           <td ><span class="tb_h3">
             <input name="ssubgroup" type="text" class="sign_inp" id="ssubgroup" style="width:400px;" />
           </span> <br />&nbsp;<strong>Example: For Country director: CD</strong></td>
         </tr>
         <tr>
           <td class="tb_h3" >Group Name:</td>
           <td ><span class="tb_h3">
             <?php
              echo getGroupDD();
			 ?>
        ...
        <tr>
          <td height="17">&nbsp;</td>
          <td class="tb_h3" ><input type="submit" name="editmembers" id="register" value="Add SubGroup"  />
