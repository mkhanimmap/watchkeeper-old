...
if(isset($_POST["add"]))
 {
				...
				$group_id = getField('group_id','sms_subgroup',base64_decode($gid));
				$val = "";
				$error[] = "";
				...
				foreach($addtogroup as $val)
				{
				    ...
				    $qry = "select id from sms_user_group where user_id =".$val." and group_id =".$group_id;
					...
					if(empty($rss))
					...
					else
					 {
						 ...
						 $where =  "id = ".$rss->id;			
						 $val = $admin->UpdateRec('sms_user_group',$where ,$arrValue);
					 }
			    }
...
$pages->baseQry  = "Select u.* from sms_user u where u.id not in (select user_id from sms_user_group where subgroup_id =".base64_decode($gid).") and u.status = 1 order by u.id desc";
  ...
  <div class="mid"> 
    ...
    <div>
      <form name="form_plan" id="form_plan" action="" method="post" >
        ...
        <br/>
          <span class="h1_box_2"> 
        	<div class="all_box">Assign Members to <?php echo getField('subgroup','sms_subgroup',base64_decode($gid));?></div></span>
          <br />
        ...
        <div></div> 
          ...
          <table width="100%" height="28" cellpadding="2" cellspacing="2">
            <tr>
              ...
              <td class="tb_h2">&nbsp;</td>
              <td class="tb_h2">&nbsp;</td>
              <td class="tb_h2" align="right"><input type="button" name="button" id="button" value="Back" onclick="javascript:window.location.href='subgroup_members.php?gid=<?php echo $gid?>'" /></td>
          ...
          if(!empty($rows))
            ...
            <tr bgcolor="#FBD4D5">
              ...
              <td width="80" class="tb_h2">Select</td>
              <td width="329" height="20" class="tb_h2"><a href="add_group.php" class="hea_txt">Members</a></td>
		    ...
		    <tr>
              <td align="left" colspan="6" class="tb_h2">
               <input type="submit" name="add" id="add" value="Assign Members to <?php echo getField('subgroup','sms_subgroup',base64_decode($gid));?>" />
              </td>
            </tr>
            <tr>
