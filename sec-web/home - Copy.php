...
<div id="panelkanan">	
    ...
    <!-- <div id='jqxWidget3'>
		...
		$qry_alert = "select i.id,i.date, i.time, i.country, c.country, i.location, i.desc, country_short, i.incidenttype 
		from \"incidentEvents\" i
		...
		<?php
				...
				while ($rowAlert = pg_fetch_array($resAlert)){
			        ...
			        // echo "<tr>
			            ...
			            // <td>".$rowAlert['desc']."</td>
			        // </tr>";
			        echo "<div class=\"flag ".strtolower($rowAlert['country_short'])."\" ></div><img height=15px src='images/".$rowAlert['incidenttype'].".png'> <b>".$rowAlert['location'].", ".$date->format('d-m-Y')." ".$rowAlert['time']."</b><br/>".$rowAlert['desc']."<br/><br/>";
				}
		?>	
		</div>	
	</div> -->
        ...
        <div>
			...
			<?php
					...
					while ($rowAlert = pg_fetch_array($resAlert)){
				        ...
				        echo "<img height=15px src='images/small_".$rowAlert['icon']."'>&nbsp;<img height=15px src='images/".$rowAlert['incidenttype'].".png'> <b>".$rowAlert['location'].", ".$date->format('d-m-Y')." ".$rowAlert['time']."</b><br/>".$rowAlert['desc']."<br/><br/>";
					}
			?>	
			</div>
        </div>
